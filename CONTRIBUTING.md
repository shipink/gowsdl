...
* In Github, fork `https://github.com/shipink/gowsdl` to your own account
* Get the package using "go get": `go get github.com/shipink/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/shipink/gowsdl/`
